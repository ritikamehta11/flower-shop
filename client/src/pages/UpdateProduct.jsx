...
export const UpdateProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`https://flower-shop-ochre.vercel.app//api/shop/${id}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://flower-shop-ochre.vercel.app/api/shop/update/${id}`, formData, {
        headers: {
