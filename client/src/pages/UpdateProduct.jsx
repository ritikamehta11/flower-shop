...
export const UpdateProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`https://flower-shop-1qtms7z64-ritika-mehtas-projects.vercel.app//api/shop/${id}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://flower-shop-1qtms7z64-ritika-mehtas-projects.vercel.app/api/shop/update/${id}`, formData, {
        headers: {
